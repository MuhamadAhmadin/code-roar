<template>
  <section class="section__list-kode">
    ...
    <div class="flex justify-center items-center">
      ...
      <Button v-else color="orange" @click="paginationHandler('mundur')" > ⬅️ </Button>
      ...
      <Button v-else color="orange" @click="paginationHandler('maju')" > ➡️ </Button>
    </div>
  </section>
</template>
...
<style scoped lang="postcss"> 
  ...
  .section__list-kode{
    @apply w-full text-center min-h-screen py-5 bg-gradient-to-tl from-yellow-700 via-red-800 to-orange-900
  }
